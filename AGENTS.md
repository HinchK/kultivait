...
- **State File**: For complex tasks or extended planning, maintain a state file (`STATE.md` at the repo root; create it if absent; it is gitignored, so never commit it) with decisions, open items, and next steps.
